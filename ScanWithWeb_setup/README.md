...
| 文件 | 说明 |
|------|------|
| `dist/installer/ScanWithWeb_Setup_x64_v2.0.7.exe` | 64位安装包 |
| `dist/installer/ScanWithWeb_Setup_x86_v2.0.7.exe` | 32位安装包 |
...
发布前建议对安装包进行数字签名：
```batch
signtool sign /f certificate.pfx /p password /t http://timestamp.digicert.com ScanWithWeb_Setup_x64_v2.0.7.exe
```
